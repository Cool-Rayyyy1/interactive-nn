...
<section class="bg-white overflow-hidden" id="parameter-table">
  <div class="tech-header bg-[#E4E3E0] border-b border-[#141414] p-3 flex justify-between items-center">
    ...
    <span class="text-[9px] text-[#141414]/60 font-mono font-bold">REG_DUMP (FLOAT64)</span>
  </div>
  <div class="grid grid-cols-2 divide-x divide-[#141414]">
    <div class="p-4 bg-white">
      <h3 class="text-[10px] font-bold uppercase tracking-widest text-[#141414]/60 mb-3 font-mono">Weights (W)</h3>
      <div class="space-y-1">
        {#each Object.entries(WEIGHT_NOTATION) as [key, notation]}
          <div 
            class={cn(
              "flex justify-between items-center px-2 py-1.5 text-[11px] font-mono transition-all border-l-2",
              activeElement === key 
    ...
    <div class="p-4 bg-white">
      <h3 class="text-[10px] font-bold uppercase tracking-widest text-[#141414]/60 mb-3 font-mono">Biases (B)</h3>
      <div class="space-y-1">
