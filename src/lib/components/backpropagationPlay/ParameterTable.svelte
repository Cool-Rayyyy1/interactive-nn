...
<section class="bg-white overflow-hidden" id="parameter-table">
  <div class="tech-header bg-[#f5f5f5] border-b border-black/30 p-3 flex justify-between items-center">
    <h2 class=" text-xs  font-bold tracking-wider ">Parameters</h2>
  </div>
  <div class="grid grid-cols-2 divide-x divide-[#141414]">
    <div class="p-4 bg-white">
      <h3 class="text-[10px] font-bold  tracking-widest text-[#141414]/60 mb-3 ">Weights (W)</h3>
      <div class="space-y-1">
    ...
    <div class="p-4 bg-white">
      <h3 class="text-[10px] font-bold  tracking-widest text-[#141414]/60 mb-3 ">Biases (B)</h3>
      <div class="space-y-1">
